...
def generateQuiz(qgi):
  ...
  prompt = '''Create a multiple choice quiz with 10 questions.
  ...
  Each option should be listed like so: Y) where Y is a capital letter, in alphabetical order to distinguish the options.
...
while True:
    ...
    #recieve input from Java client and break once end reached
